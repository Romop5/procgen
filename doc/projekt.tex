...
\projectinfo{
  ...
  title.cs={Jazyk pre procedurálne generovanie},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Language for procedural generation}, % název práce v angličtině / thesis title in english
  ...
  supervisor.surname={Milét},   % příjmení školitele / supervisor surname
...
\begin{document}
  ...
  % ----------------------------------------------
	...
	\input{projekt-02-lsystems}
	\input{projekt-03-formallanguages}
	\input{projekt-04-design.tex}
	\input{projekt-05-implementacia.tex}
